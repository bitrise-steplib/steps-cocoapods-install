...
func GenerateOptions(projectType XcodeProjectType, searchDir string, excludeAppIcon bool) (models.OptionNode, []ConfigDescriptor, models.Icons, models.Warnings, error) {
	...
	projectPathOption := models.NewOption(ProjectPathInputTitle, ProjectPathInputEnvKey, models.TypeSelector)
	...
	for _, project := range standaloneProjects {
		...
		schemeOption := models.NewOption(SchemeInputTitle, SchemeInputEnvKey, models.TypeSelector)
		...
		if len(project.SharedSchemes) == 0 {
			...
			for _, target := range project.Targets {
				...
				exportMethodOption := models.NewOption(exportMethodInputTitle, ExportMethodInputEnvKey, models.TypeSelector)
...
func GenerateDefaultOptions(projectType XcodeProjectType) models.OptionNode {
	projectPathOption := models.NewOption(ProjectPathInputTitle, ProjectPathInputEnvKey, models.TypeUserInput)

	schemeOption := models.NewOption(SchemeInputTitle, SchemeInputEnvKey, models.TypeUserInput)
